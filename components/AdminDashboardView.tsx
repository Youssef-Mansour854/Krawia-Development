      ...
      <main className="mx-auto max-w-7xl w-full px-4 sm:px-6 py-6 sm:py-10 flex-1 space-y-6 sm:space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-border pb-6">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center bg-accent hover:bg-accent-hover text-white text-xs font-semibold uppercase tracking-widest px-6 py-3 transition-colors shadow-sm w-full sm:w-auto"
          >
            + إضافة مشروع جديد
          </Link>
        </div>
        ...
        {filteredProjects.length === 0 ? (
          ...
          <div className="bg-white border border-border overflow-x-auto shadow-sm w-full">
            <table className="w-full min-w-[680px] text-right border-collapse">
              <thead>
